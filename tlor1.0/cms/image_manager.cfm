...
<cfelse>
	...
	<cfquery name="GetRecords" datasource="#Application.DataSource#">
		SELECT i.*, wf.work_flow
		FROM cms_images i
		LEFT OUTER JOIN cms_work_flow wf ON wf.work_flow_id = i.work_flow_id
	...
	<cfset TabArray[2][2] = "image_manager_edit.cfm?Module=#Module#">	
	...
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  ...
	  <tr bgcolor="##CC6600">
		...
		<td><cfif OrderBy CONTAINS 'image_name'><img src="images/order_<cfif NOT len(trim(OrderDirection))>up<cfelse>down</cfif>.gif" width="15" height="20" border="0"><cfelse>&nbsp;</cfif></td>
		<td><a href="?HowMany=#HowMany#&Module=#Module#&OrderDirection=#OrderDirection#&OrderBy=image_name&ToggleOrder=1" class="txt_column">IMAGE NAME</a></td>
	  ...
	  <cfif GetRecords.RecordCount>
		  ...
		  <cfloop query="GetRecords" endrow="#HowMany#">
			  ...
			  <tr bgcolor="##CCCCCC">
				...
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
				<td class="txt"><cfif len(image_name) GT 60>#left(image_name,"60")#...<cfelse>#image_name#</cfif></td>
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
