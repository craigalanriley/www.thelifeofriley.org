...
<cfelse>
	...
	<cfparam name="OrderBy" default="date_edited">
	...
	<cfquery name="GetRecords" datasource="#Application.DataSource#">
		SELECT wf.*, s.section, a.*
		FROM articles a
		LEFT OUTER JOIN cms_work_flow wf ON wf.work_flow_id = a.work_flow_id
		LEFT OUTER JOIN modules m ON a.module_id = m.module_id
		LEFT OUTER JOIN sections s ON a.section_id = s.section_id
	...
	<cfset TabArray[2][2] = "news_edit.cfm?Module=#Module#">	
	...
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  ...
	  <tr bgcolor="##CC6600">
		...
		<td><cfif OrderBy CONTAINS 'section'><img src="images/order_<cfif NOT len(trim(OrderDirection))>up<cfelse>down</cfif>.gif" width="15" height="20" border="0"><cfelse>&nbsp;</cfif></td>
		<td><a href="?HowMany=#HowMany#&Module=#Module#&OrderDirection=#OrderDirection#&OrderBy=section&ToggleOrder=1" class="txt_column">SECTION</a></td>
		<td><cfif OrderBy CONTAINS 'date_edited'><img src="images/order_<cfif NOT len(trim(OrderDirection))>up<cfelse>down</cfif>.gif" width="15" height="20" border="0"><cfelse>&nbsp;</cfif></td>
		<td><a href="?HowMany=#HowMany#&Module=#Module#&OrderDirection=#OrderDirection#&OrderBy=date_edited&ToggleOrder=1" class="txt_column">DATE MODIFIED</a></td>
		<td><img src="images/dotpix.gif" width="1" height="1" border="0"></td>
		<td><img src="images/dotpix.gif" width="1" height="1" border="0"></td>
		<td><img src="images/dotpix.gif" width="1" height="1" border="0"></td>
		<td><img src="images/dotpix.gif" width="1" height="1" border="0"></td>
	  ...
	  <cfif GetRecords.RecordCount>
		  ...
		  <cfloop query="GetRecords" endrow="#HowMany#">
			  ...
			  <tr bgcolor="##CCCCCC">
				...
				<td><cfif thumb_id><img src="images/picture.png" alt=" Preview Image " width="13" height="13" border="0"></cfif></td>
				<td class="txt"><cfif len(title) GT 50>#left(title,"50")#...<cfelse>#title#</cfif></td>
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
				<td class="txt">#section#</td>
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
				<td class="txt">#DateFormat(date_edited,"dd-mm-yyyy")# @ #TimeFormat(date_edited,"HH:mm")#</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
