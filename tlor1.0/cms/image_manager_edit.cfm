...
<cfelse>
	...
	<cfset FieldList="image_name,file_name,work_flow_id">
	<cfset ReqList="image_name,file_name,work_flow_id">
	...
	<cfset TabArray[1][2] = "image_manager.cfm?Module=#Module#">
	<cfset TabArray[2][1] = "Edit">
	<cfset TabArray[2][2] = "image_manager_edit.cfm?Module=#Module#&ID=#ID#">	
	<cfset TabArray[3][1] = "Add">
	<cfset TabArray[3][2] = "image_manager_edit.cfm?Module=#Module#">
	
	<cfparam name="DefaultTab" default="3">
	<cfparam name="InactiveTabList" default="2">

	<cfinclude template="includes/inc_action_imagemanager.cfm">
	...
	<cfif len(trim(ID))>
		...
		<cfquery name="GetDocumentModules" datasource="#Application.DataSource#">
			SELECT iml.module_id
			FROM cms_img_mod_lookup iml
			WHERE #FieldID# = #ID#
		</cfquery>		
