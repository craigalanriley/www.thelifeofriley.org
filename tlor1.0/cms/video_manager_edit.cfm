...
<cfelse>
	...
	<cfset FieldList="title,file_name,front_page,work_flow_id">
	<cfset ReqList="title,file_name,work_flow_id">
	...
	<cfset TabArray[1][2] = "video_manager.cfm?Module=#Module#">
	<cfset TabArray[2][1] = "Edit">
	<cfset TabArray[2][2] = "video_manager_edit.cfm?Module=#Module#&ID=#ID#">	
	<cfset TabArray[3][1] = "Add">
	<cfset TabArray[3][2] = "video_manager_edit.cfm?Module=#Module#">
	
	<cfparam name="DefaultTab" default="3">
	<cfparam name="InactiveTabList" default="2">

	<cfinclude template="includes/inc_action_videomanager.cfm">
	...
	<form name="frm" method="post" action="" enctype="multipart/form-data">
	  ...
	  <cfset FieldHint = "You Tube Embed ID">
	  <tr bgcolor="##FFFFFF"><td colspan="6"><img src="images/dotpix.gif" width="1" height="1" border="0"></td></tr>
	  <tr bgcolor="##CCCCCC" id="#FieldName#">
		<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
	  ...
	  <cfset FieldHint = "Video will be displaed on home page clip of the day box">
	  <tr bgcolor="##FFFFFF"><td colspan="6"><img src="images/dotpix.gif" width="1" height="1" border="0"></td></tr>
	  <tr bgcolor="##CCCCCC" id="#FieldName#">
		<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
	  ...
	  <tr bgcolor="##CCCCCC" id="#FieldName#">
		...
		<cfif len(trim(ID))>
			...
			<td><a href="#Application.Home#uploads/images/#Evaluate('GetData.' & FieldName)#" class="footer" target="_blank">#Evaluate('GetData.' & FieldName)#</a></td>
			<input type="hidden" name="#FieldName#" value="#Evaluate('GetData.' & FieldName)#">
		<cfelse>
			<td class="txt" align="center"><cfif ListFind(ReqList,"#FieldName#")>*<cfelse>&nbsp;</cfif></td>
	  ...
	  <tr bgcolor="##CCCCCC" id="#FieldName#">
		...
		<td class="txt">			
			...
			<cfelse>
				<td class="txt">[ No Modules Require Images ]</td>
	  ...
	  <tr bgcolor="##CCCCCC" id="#FieldName#">
		...
		<td>
			...
			<select name="#FieldName#">
				<option value="0" class="frm_list_select">Please Select</option>
