...
<cfelse>
	...
	<cfset TabArray[2][2] = "page_manager_edit.cfm?Module=#Module#">	
	...
	<cfquery name="GetRecords" datasource="#Application.DataSource#">
		SELECT p.*, wf.work_flow
		FROM cms_pages p
		LEFT OUTER JOIN cms_work_flow wf ON wf.work_flow_id = p.work_flow_id
	...
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  ...
	  <tr bgcolor="##CC6600">
		...
		<td><a href="?HowMany=#HowMany#&Module=#Module#&OrderDirection=#OrderDirection#&OrderBy=page_title&ToggleOrder=1" class="txt_column">PAGE TITLE</a></td>
		<td></td>
		<td></td>
	  ...
	  <cfif GetRecords.RecordCount>
		  ...
		  <tr bgcolor="##CCCCCC">
				...
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
				<td class="txt"><cfif len(page_title) GT 60>#left(page_title,"60")#...<cfelse>#page_title#</cfif></td>
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
				<td class="txt"><!--- <cfif len(image_name) GT 15>#left(image_name,"15")#...<cfelse>#image_name#</cfif> ---></td>
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
