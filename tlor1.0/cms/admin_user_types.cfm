...
<cfelse>
	...
	<cfquery name="GetRecords" datasource="#Application.DataSource#">
		SELECT aut.*, wf.work_flow
		FROM cms_user_types aut
		LEFT OUTER JOIN cms_work_flow wf ON wf.work_flow_id = aut.work_flow_id
		<cfif NOT Session.UserID EQ 1>
			WHERE admin_user_type_id > 1
		</cfif>
	...
	<cfset TabArray[2][2] = "admin_user_types_edit.cfm?Module=#Module#">	
	  ...
	  <cfif GetRecords.RecordCount>
		  ...
		  <cfloop query="GetRecords" endrow="#HowMany#">
			  ...
			  <tr bgcolor="##CCCCCC">
				...
				<td><img src="images/dotpix.gif" width="1" height="25" border="0"></td>
				<td class="txt"><cfif len(admin_user_type) GT 75>#left(admin_user_type,"75")#...<cfelse>#admin_user_type#</cfif></td>
				<td>&nbsp;</td>
				<td class="txt">&nbsp;</td>
				<td>&nbsp;</td>
