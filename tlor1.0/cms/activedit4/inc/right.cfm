...
<cfquery name="GetModuleImages" datasource="atp">
	SELECT i.*
	FROM cms_images i<cfif isDefined("Module")>, cms_img_mod_lookup iml, cms_modules m</cfif>
	WHERE work_flow_id = 1
	<cfif isDefined("Module")>		
		AND i.image_id = iml.image_id
