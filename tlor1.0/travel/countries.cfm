	...
	<tr>
  	...
  	<tr>
		...
		<cfif NOT isDefined("CountryID")>			
			...
			<tr>
				...
				<cfinvoke component="#Application.CompsPath#/content_photo" method="Display" 
							FileName="passportstamps.jpg"
							ImageText="Various Passport Stamps">
				<span class="txt_header">#ThisPage#</span>
				<br>						
				I once wrote on my CV that my ambition was to visit every country in the world before I die, I also dreamt of
				...
				<p>
				Sadly too many countries (mostly in Africa) are war torn and suffer from extreme poverty and disease. 
				...
				<p>
				I have visited a great number of countries already but there is still so much more to see. 
			...
			<tr>
				<td>						
				<cfinvoke component="#Application.CompsPath#/countries" method="Articles" 
		...
		<cfelse>		
			...
			<tr>
				<td>						
				<cfinvoke component="#Application.CompsPath#/countries" method="ArticleData" 
							Datasource="#Application.Datasource#"
							Home="#Application.Home#" 
							CountryID="#CountryID#">
