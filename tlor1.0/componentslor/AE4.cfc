<cfcomponent>
	<cffunction name="GUI" access="public" returntype="string" output="true">
		...
		<cfargument name="Toolbar" type="string" required="no" default="justifyleft,justifycenter,justifyright,bullets,bold,italic,underline,subscript,superscript,strike,specialchars,hyperlink,image,||,quickstyles,removeformat,replace,paste,cut,copy,redo,undo,help">
		...
		<tr bgcolor="##FFFFFF">
			...
			<cf_activedit4_atp 
				...
				inc="#Application.Home#xroom/ActivEdit4/inc/" 
