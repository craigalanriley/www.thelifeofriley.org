...
<cfset MustList="IMAGE_NAME,FILE_NAME,IMAGE_TYPE_ID,DATE_DISPLAY,STATUS_ID">
...
<cfif isDefined("Action")>
					...
					<cfif len(trim(FILE_NAME))>
						...
						<cfelse>
							...
							<cfquery datasource="#Application.datasource#" >
								INSERT INTO images(#FieldList#,DATE_EDITED,DATE_CREATED)
								VALUES('#IMAGE_NAME#','#file.ServerFile#','#BIG_FILE_NAME#','#SUMMARY#','#FRONT_PAGE#','#GALLERY#','#IMAGE_TYPE_ID#',
								'#COUNTRY_ID#',#CreateODBCDate(DATE_DISPLAY)#,#STATUS_ID#,#CreateODBCDate(Now())#,#CreateODBCDate(Now())#)
							</cfquery>
	...
	<cfelse>
		<cfif isDefined("ImageID")>
			...
			<cflocation url="image_uploads.cfm?ModuleID=#ModuleID#&Message=#Message#" addtoken="no">
		<cfelse>
	...
	<tr>
  	...
  	<tr>
    	...
    	<td bgcolor="##EAEAEA" class="txt" valign="top">
			...
			<form action="image_uploads_edit.cfm" method="post" enctype="multipart/form-data">
			<tr>
				<td><img src="../images/dotpix.gif" height="1" width="1"></td>
				<td><img src="../images/dotpix.gif" height="1" width="1"></td>
				<td>NAME</td>
