    	...
    	<td bgcolor="##EAEAEA" class="txt" valign="top">
			...
			<cfloop query="GetNews">
				...
				<tr>
					...
					<td><a href="news_edit.cfm?ModuleID=#ModuleID#&ArticleID=#ARTICLE_ID#" class="txt_link"><cfif len(TITLE) GT 40>#LEFT(TITLE,"40")#...<cfelse>#TITLE#</cfif></a></td>
					<td class="txt">#SECTION#</td>
					<td>#DateFormat(DATE_DISPLAY,"dd-mm-yyyy")#</td>
					<td><a href="news.cfm?ModuleID=#ModuleID#&ArticleID=#ARTICLE_ID#&Action=Delete" class="txt_link"><img src="images/icons/delete.gif" alt=" DELETE " width="20" height="20" border="0"></a></td>
					<td><a href="news_edit.cfm?ModuleID=#ModuleID#&ArticleID=#ARTICLE_ID#" class="txt_link"><img src="images/icons/edit.gif" alt=" EDIT " width="20" height="20" border="0"></a></td>
				</tr>			
			</cfloop>
			<tr>
				<td colspan="7" bgcolor="##FFFFFF"><img src="../images/dotpix.gif" height="2" width="1"></td>
