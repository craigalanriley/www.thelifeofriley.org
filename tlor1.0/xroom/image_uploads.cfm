...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="##FFFFFF">
	<tr>
		...
		<td bgcolor="##EAEAEA"><span class="txt_header">Image Uploads</span> <cfif len(trim(Message))><span class="txt_message"> - <cfoutput>#Message#</cfoutput></span></cfif></td>
	</tr>
  	<tr>
    	...
    	<td bgcolor="##EAEAEA" class="txt" valign="top">
			...
			<tr bgcolor="##999999">
				...
				<td class="txt_columns">IMAGE NAME</td>
			...
			<cfloop query="GetImages">
				...
				<tr>
					...
					<td><a href="image_uploads_edit.cfm?ModuleID=#ModuleID#&ImageID=#IMAGE_ID#" class="txt_link">#IMAGE_NAME#</a></td>
					...
					<td><a href="image_uploads_edit.cfm?ModuleID=#ModuleID#&ImageID=#IMAGE_ID#" class="txt_link"><img src="images/icons/edit.gif" alt=" EDIT " width="20" height="20" border="0"></a></td>
				</tr>			
			</cfloop>
			<tr>
				<td colspan="7" bgcolor="##FFFFFF"><img src="../images/dotpix.gif" height="2" width="1"></td>
			...
			<tr>	
				<td colspan="7" align="center">
					...
					<cfoutput>
						<form action="image_uploads_edit.cfm" method="post">
