  	...
  	<tr>
    	...
    	<td bgcolor="##EAEAEA" class="txt" valign="top">
			...
			<cfquery name="GetNews" datasource="#Application.Datasource#">
				SELECT a.ARTICLE_ID, a.TITLE, a.DATE_DISPLAY, a.STATUS_ID, s.SECTION, i.FILE_NAME
				FROM articles a<cfif isDefined("CategoryID")>, article_category_lookup acl</cfif>
				LEFT OUTER JOIN sections s ON s.SECTION_ID = a.SECTION_ID
				LEFT OUTER JOIN images i ON i.IMAGE_ID = a.THUMB_ID
				WHERE MODULE_ID = #ModuleID#
				<cfif isDefined("CategoryID")>
					AND acl.ARTICLE_ID = a.ARTICLE_ID
					AND acl.CATEGORY_ID = #CategoryID#
				</cfif>
			...
			<cfloop query="GetNews">
				...
				<tr>
					...
					<td><a href="portfolio_edit.cfm?ModuleID=#ModuleID#&ArticleID=#ARTICLE_ID#" class="txt_link"><cfif len(TITLE) GT 40>#LEFT(TITLE,"40")#...<cfelse>#TITLE#</cfif></a></td>
					<td class="txt">#SECTION#</td>
					<td>#DateFormat(DATE_DISPLAY,"dd-mm-yyyy")#</td>
					<td><a href="portfolio.cfm?ModuleID=#ModuleID#&ArticleID=#ARTICLE_ID#&Action=Delete" class="txt_link"><img src="images/icons/delete.gif" alt=" DELETE " width="20" height="20" border="0"></a></td>
					<td><a href="portfolio_edit.cfm?ModuleID=#ModuleID#&ArticleID=#ARTICLE_ID#" class="txt_link"><img src="images/icons/edit.gif" alt=" EDIT " width="20" height="20" border="0"></a></td>
				</tr>			
			</cfloop>
			<tr>
				<td colspan="7" bgcolor="##FFFFFF"><img src="../images/dotpix.gif" height="2" width="1"></td>
