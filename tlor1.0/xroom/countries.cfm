...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="FFFFFF">
	<tr>
		...
		<td bgcolor="##EAEAEA"><span class="txt_header">Countries</span> <cfif len(trim(Message))><span class="txt_message"> - #Message#</span></cfif></td>
	</tr>
  	<tr>
    	...
    	<td bgcolor="##EAEAEA" class="txt" valign="top">
			...
			<tr bgcolor="##999999">
				...
				<td class="txt_columns">COUNTRY</td>
				<td class="txt_columns">CONTINENT</td>
			...
			<cfloop query="GetCountries">
				...
				<tr>
					...
					<td><a href="country_edit.cfm?ModuleID=#ModuleID#&CountryID=#COUNTRY_ID#" class="txt_link"><cfif len(COUNTRY) GT 40>#LEFT(COUNTRY,"40")#...<cfelse>#COUNTRY#</cfif></a></td>
					<td class="txt">#CONTINENT#</td>
					<td>#DateFormat(DATE_CREATED,"dd-mm-yyyy")#</td>
					<td><a href="countries.cfm?ModuleID=#ModuleID#&CountryID=#COUNTRY_ID#&Action=Delete" class="txt_link"><img src="images/icons/delete.gif" alt=" DELETE " width="20" height="20" border="0"></a></td>
					<td><a href="country_edit.cfm?ModuleID=#ModuleID#&CountryID=#COUNTRY_ID#" class="txt_link"><img src="images/icons/edit.gif" alt=" EDIT " width="20" height="20" border="0"></a></td>
				</tr>			
			</cfloop>
			<tr>
				<td colspan="7" bgcolor="##FFFFFF"><img src="images/dotpix.gif" height="2" width="1"></td>
